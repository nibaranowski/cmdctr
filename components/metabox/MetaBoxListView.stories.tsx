...
const meta: Meta<typeof MetaBoxListView> = {
  title: 'MetaBox/MetaBoxListView',
  component: MetaBoxListView,
  parameters: {
    layout: 'padded',
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    onObjectUpdate: {
      ...
      description: 'Callback when an object is updated',
    },
    onObjectDelete: {
      action: 'object deleted',
      description: 'Callback when an object is deleted',
    },
    'data-testid': {
      control: 'text',
...
export const WithTestId: Story = {
  args: {
    ...
    selectedObjectId: null,
    canEdit: true,
    'data-testid': 'metabox-list-view-test',
  },
}; 