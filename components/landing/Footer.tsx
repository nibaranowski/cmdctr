...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Email', icon: Mail, href: 'mailto:hello@cmdctr.com' },
  ];

  return (
    <footer className="bg-background-secondary border-t border-border">
      <div className="mx-auto px-4 max-w-[1400px] py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-text-secondary/80 mb-6 max-w-sm">
              The AI-native command center for modern businesses. Orchestrate your entire company with intelligent automation.
            </p>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text-secondary/60 text-sm">
            © {currentYear} cmdctr. All rights reserved.
          </p>
          <p className="text-text-secondary/60 text-sm">
